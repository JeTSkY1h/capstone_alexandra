...
public class BookServiceTest {
    ...
    BookService bookService = new BookService(bookRepo, cloudinaryService);
    ...
    void shouldAddBooks() throws Exception {
        ...
        expectedBook.setFilePath(bookURL);
        expectedBook.setCoverPath(bookpath + File.separator + "WarAndPeace.Png");
    ...
    void shouldListBooks() throws Exception {
        ...
        expectedBook.setCoverPath(bookpath + File.separator + "WarAndPeace.Png");
        Mockito.when(cloudinaryService.getBookURLs()).thenReturn(List.of(bookURL));
        Mockito.when(bookRepo.findAll()).thenReturn(List.of(expectedBook));

        List<Book> actual = bookService.getBooks();
        Mockito.verify(bookRepo).findAll();
        Assertions.assertThat(actual).isEqualTo(List.of(expectedBook));
    }
    ...
    @Test
    void shouldGetCoverPicByBookId() throws Exception{
        Book expectedBook = new Book();
        expectedBook.setTitle("War and Peace");
        expectedBook.setAuthor("Tolstoy, graf Leo");
        expectedBook.setGenre(List.of("Historical fiction", "War stories", "Napoleonic Wars, 1800-1815 -- Campaigns -- Russia -- Fiction", "Russia -- History -- Alexander I, 1801-1825 -- Fiction", "Aristocracy (Social class) -- Russia -- Fiction"));
        ...
        try {
            byte[] expected = expectedBook.getCoverPath().getBytes();
    ...
    @Test
    void shouldListChapters() throws Exception{
        Book expectedBook = new Book();
        expectedBook.setTitle("War and Peace");
        expectedBook.setAuthor("Tolstoy, graf Leo");
        expectedBook.setGenre(List.of("Historical fiction", "War stories", "Napoleonic Wars, 1800-1815 -- Campaigns -- Russia -- Fiction", "Russia -- History -- Alexander I, 1801-1825 -- Fiction", "Aristocracy (Social class) -- Russia -- Fiction"));
        ...
        expectedBook.setCoverPath(bookpath + File.separator + "WarAndPeace.Png");
        Mockito.when(cloudinaryService.getBookURLs()).thenReturn(List.of(bookURL));
        List<String> expectedChapters = List.of(
                "WAR AND PEACE",
                "Contents",
                "BOOK ONE: 1805",
                "CHAPTER I",
    ...
    @Test
    void shouldGetChapterText() throws Exception{
        Book expectedBook = new Book();
        expectedBook.setTitle("War and Peace");
        expectedBook.setAuthor("Tolstoy, graf Leo");
        expectedBook.setGenre(List.of("Historical fiction", "War stories", "Napoleonic Wars, 1800-1815 -- Campaigns -- Russia -- Fiction", "Russia -- History -- Alexander I, 1801-1825 -- Fiction", "Aristocracy (Social class) -- Russia -- Fiction"));
